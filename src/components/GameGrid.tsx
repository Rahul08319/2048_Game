...
export const GameGrid = ({ tiles }: GameGridProps) => (
  <div className="playable-board relative aspect-square shrink-0 rounded-[2rem] bg-[hsl(var(--card))] p-[3.45%] shadow-2xl touch-none" role="img" aria-label={`2048 board with ${tiles.length} tiles`}>
